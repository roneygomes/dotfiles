# Generated by Powerlevel10k configuration wizard on 2026-02-20 at 15:06 -03.
...
# left frame, black-ornaments, sparse, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    container               # container indicator (visible only when IN_CONTAINER is set)
  ...
  # Container indicator: shown only when IN_CONTAINER env var is set (e.g. inside Docker).
  function prompt_container() {
    [[ -n "$IN_CONTAINER" ]] || return
    p10k segment -f 4 -t '⬡ docker'
  }
