...
"-------------------------------------------------------------------------------
" Some configurations required for Windows.
"-------------------------------------------------------------------------------
if has("win64") || has("win32") || has("win16")
    au GUIEnter * simalt ~x
    set backupdir=c:/Program\ Files/Vim/backups
else
...
"    F3 - Calls the file explorer (NERDTree). 
"-------------------------------------------------------------------------------
...
"-------------------------------------------------------------------------------
" Eighty Colors Margin Delimiter  
"-------------------------------------------------------------------------------
...
" Specify the following order of appearence to files under a 
" certain node in the directories tree:
" 1 - *.h files.
" 2 - *.c files.
" 3 - *.cpp files.
" 4 - Any kind of files (in alphabetical order).
" 5 - Folders.
